...
public abstract class ConnectionConfiguration implements Serializable {
  ...
  RestHighLevelClientAdapter createClient(int version) throws IOException {
    ...
    return AdapterFactory.restHighLevelClientAdapter(version,
            new RestHighLevelClientAdapter.Configuration(hosts,
                    credentialsProvider,
                    sslContext,
                    sessionStrategy,
                    getConnectTimeout(),
