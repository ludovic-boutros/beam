...
import org.apache.beam.repackaged.elasticsearch7_driver.org.apache.http.auth.AuthScope;
import org.apache.beam.repackaged.elasticsearch7_driver.org.apache.http.auth.UsernamePasswordCredentials;
import org.apache.beam.repackaged.elasticsearch7_driver.org.apache.http.client.CredentialsProvider;
import org.apache.beam.repackaged.elasticsearch7_driver.org.apache.http.conn.ssl.TrustSelfSignedStrategy;
import org.apache.beam.repackaged.elasticsearch7_driver.org.apache.http.impl.client.BasicCredentialsProvider;
import org.apache.beam.repackaged.elasticsearch7_driver.org.apache.http.nio.conn.ssl.SSLIOSessionStrategy;
import org.apache.beam.repackaged.elasticsearch7_driver.org.apache.http.ssl.SSLContexts;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.action.DocWriteRequest;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.action.DocWriteResponse;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.action.admin.cluster.health.ClusterHealthRequest;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.action.admin.cluster.health.ClusterHealthResponse;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.action.admin.indices.delete.DeleteIndexRequest;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.action.admin.indices.refresh.RefreshRequest;
...
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.action.get.GetRequest;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.action.get.GetResponse;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.action.index.IndexRequest;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.action.index.IndexResponse;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.action.support.replication.ReplicationResponse;
...
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.client.indices.CreateIndexRequest;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.client.indices.GetIndexRequest;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.cluster.health.ClusterHealthStatus;
...
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.common.settings.Settings;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.common.xcontent.XContentType;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.index.VersionType;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.index.query.QueryBuilders;
import org.apache.beam.repackaged.elasticsearch7_driver.org.elasticsearch.index.shard.ShardId;
